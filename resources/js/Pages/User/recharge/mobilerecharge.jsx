  ...
  {operators.map((op) => (
    <option key={op.id} value={op.id} className="text-green-800">
      {op.name}
              ...
              <Input type="tel" placeholder="Mobile Number" value={formData.canumber} onChange={(e) => setFormData({ ...formData, canumber: e.target.value })} required pattern="[0-9]{10}" maxLength={10} className="w-full border shadow-md" />
              <Input type="number" placeholder="Amount" value={formData.amount} onChange={(e) => setFormData({ ...formData, amount: e.target.value })} required min="1" className="w-full border shadow-md" />
              <Input type="number" placeholder="Reference Number" value={formData.referenceid} onChange={(e) => setFormData({ ...formData, referenceid: e.target.value })} required min="1" className="w-full border shadow-md" />
              
              <Button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-[#497D74]  to-gray-400 text-white hover:shadow-lg transition-all duration-300">
          ...
          <Tab.Panel>
            <form onSubmit={checkStatus} className="space-y-4">
              <Input type="text" placeholder="Reference ID" value={statusReferenceId} onChange={(e) => setStatusReferenceId(e.target.value)} required className="w-full border shadow-md" />
