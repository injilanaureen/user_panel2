...
public function registerBeneficiaryOpen()
{
    return Inertia::render('User/beneficiary2/registerBeneficiary');
}
...
public function fetchBeneficiaryOpen()
{
    return Inertia::render('User/beneficiary2/registerBeneficiary');
}
public function fetchBeneficiary(Request $request)
{
    ...
    {
        return Inertia::render('User/beneficiary2/deleteBeneficiary');
    }
    ...
    {
        return Inertia::render('User/beneficiary2/fetchbyBenied');
    }
