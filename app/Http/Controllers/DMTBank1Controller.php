...
class DMTBank1Controller extends Controller
{
    public function QueryRemitter(){
        return Inertia::render('User/remitter1/QueryRemitter');
    }
    ...
    public function Remitter1EKYC(){
        return Inertia::render('User/remitter1/RemitterE-KYC');
    }
    ...
    public function RegisterRemitter(){
        return Inertia::render('User/remitter1/RegisterRemitter');
    }
...
public function RegisterBeneficiary(){
    return Inertia::render('User/beneficiary1/RegisterBeneficiary');
}
...
{
    return Inertia::render('User/beneficiary1/DeleteBeneficiary');
}
...
public function fetchBeneficiary(Request $request)
{
    ...
    if (!$request->has('mobile')) {
        return Inertia::render('User/beneficiary1/FetchBeneficiary');
    }
...
{
    return Inertia::render('User/beneficiary1/FetchBeneficiaryByBenied');
}
...
public function pennyDrop(){
    return Inertia::render('User/transaction1/PennyDrop');
}
    ...
    public function transaction1(){
        return Inertia::render('User/transaction1/transaction');
    }
...
{
    return Inertia::render('User/transaction1/transactionOtp');
}
public function processtransaction1Otp(Request $request)
{
    try {
        ...
        {
            return Inertia::render('User/transaction1/transactionStatus');
        }
        ...
        {
            return Inertia::render('User/refund1/refundOtp');
        }
        ...
        {
            return Inertia::render('User/refund1/claimRefund');
        }
