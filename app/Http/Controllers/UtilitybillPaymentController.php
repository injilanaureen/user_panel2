...
class UtilitybillPaymentController extends Controller
{
    public function operatorList()
    {
        try {
            ...
            return Inertia::render('User/UtilityBillPayment/OperatorList', [
                'operators' => $operators,
   ...
   public function fetchBillDetails(Request $request)
    {
        ...
        if (!$request->isMethod('post')) {
            return Inertia::render('User/UtilityBillPayment/FetchBillDetails');
        }
    ...
    {
        return Inertia::render('User/UtilityBillPayment/PayBill');
    }
...
{
    return Inertia::render('User/UtilityBillPayment/UtilityStatusEnquiry');
}
