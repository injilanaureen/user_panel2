...
//Beneficiary 
Route::get('/admin/beneficiary2/registerBeneficiary', [Beneficiary2Controller::class, 'registerBeneficiaryOpen'])->name('beneficiary2.registerBeneficiary');
...
Route::get('/admin/beneficiary2/fetchBeneficiary', [Beneficiary2Controller::class, 'fetchBeneficiaryOpen'])->name('beneficiary2.fetchBeneficiary');
...
Route::get('/admin/transaction2/transactionStatus', [Transaction2Controller::class, 'transactionStatusOpen'])->name('transaction2.transactionStatus');
