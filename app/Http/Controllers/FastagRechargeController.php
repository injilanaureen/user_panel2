...
class FastagRechargeController extends Controller
{
    public function fastagRechargeOperatorList()
    {
        ...
        return Inertia::render('User/FastagRecharge/FastagOperatorList', [
            'operators' => $apiResponse
        ]);
    }
    public function fetchConsumerDetails()
    {
        return Inertia::render('User/FastagRecharge/FastagFetchConsumerDetails');
    }
    ...
    public function FastagRecharge(){
        return Inertia::render('User/FastagRecharge/FastagRecharge');
    }



    public function FastagStatus(){
        return Inertia::render('User/FastagRecharge/FastagStatus');
    }
}
