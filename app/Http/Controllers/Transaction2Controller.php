...
class Transaction2Controller extends Controller
{
    public function pennyDrop(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return Inertia::render('User/transaction2/pennyDrop', [
    ...
    public function transactionSentOtp(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            return Inertia::render('User/transaction2/transactionSentOtp', [
...
{
    return Inertia::render('User/transaction2/transaction');
}
...
public function transactionStatusOpen()
{
    return Inertia::render('User/transaction2/transactionStatus');
}
