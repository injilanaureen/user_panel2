...
class MunicipalityController extends Controller
{
    ...
    {
        return Inertia::render('User/Municipality/FetchMunicipalityDetails');
    }
    ...
    {
        return Inertia::render('User/Municipality/MunicipalityBill');
    }
    ...
    {
        return Inertia::render('User/Municipality/MunicipalityStatus');
    }
