...
class InsurancePremiumPaymentController extends Controller
{
    ...
    {
        return Inertia::render('User/InsurancePremiumPayment/FetchInsuranceBillDetails');
    }
    public function fetchLICBill(Request $request)
{
    ...
    public function payInsuranceBill(Request $request)
    {
        if ($request->isMethod('get')) {
            return Inertia::render('User/InsurancePremiumPayment/PayInsuranceBill');
        }
    ...
    {
        return Inertia::render('User/InsurancePremiumPayment/InsuranceStatusEnquiry');
    }
